...
namespace input {
	...
	struct Button {
		...
		unsigned layer() const { return static_cast<std::underlying_type_t<unsigned>>(id) >> 8; }
		unsigned num() const { return static_cast<std::underlying_type_t<unsigned>>(id) & 0xFF; }
