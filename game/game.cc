...
Game::Game(Window& _window, Audio& _audio, Songs& _songs):
  m_audio(_audio), m_window(_window), m_webserver(nullptr), m_finished(false), newScreen(), currentScreen(), currentPlaylist(),
