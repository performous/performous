...
void input::SDL::init() {
	...
	input::detail::devices.insert(std::make_pair<unsigned int, input::detail::InputDevPrivate>(input::detail::KEYBOARD_GUITAR, input::detail::InputDevPrivate(g_instruments.find("GUITAR_GUITARHERO")->second)));
	input::SDL::sdl_devices[input::detail::KEYBOARD_DRUMS] = NULL;
	input::detail::devices.insert(std::make_pair<unsigned int, input::detail::InputDevPrivate>(input::detail::KEYBOARD_DRUMS, input::detail::InputDevPrivate(g_instruments.find("DRUMS_GUITARHERO")->second)));
	input::SDL::sdl_devices[input::detail::KEYBOARD_DANCEPAD] = NULL;
	input::detail::devices.insert(std::make_pair<unsigned int, input::detail::InputDevPrivate>(input::detail::KEYBOARD_DANCEPAD, input::detail::InputDevPrivate(g_instruments.find("DANCEPAD_GENERIC")->second)));
	input::SDL::sdl_devices[input::detail::KEYBOARD_KEYBOARD] = NULL;
	input::detail::devices.insert(std::make_pair<unsigned int, input::detail::InputDevPrivate>(input::detail::KEYBOARD_KEYBOARD, input::detail::InputDevPrivate(g_instruments.find("KEYBOARD_GENERIC")->second)));
}
