...
void FixNoteGraphScaler::initialize(VocalTrack const& vocal) {
...
NoteGraphDimension FixNoteGraphScaler::calculate(VocalTrack const&, const Notes::const_iterator&, double) const {    
	return m_dimension;
}
