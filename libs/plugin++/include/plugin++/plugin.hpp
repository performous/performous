	...
	**/
	...
	public:
		...
		**/
		...
		/**
		* @short A class that fools the compiler to generate code for the registry.
		* Create an instance in your application so that DLL plugins find the code
		* on Microsoft platforms. Not needed on other systems or with static linkage.
		**/
		class init {
		public:
			init() { map(); }
