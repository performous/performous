...
Section Uninstall
  ...
  Delete "$INSTDIR\themes\default\mainmenu_back_highlight.svg"
  Delete "$INSTDIR\themes\default\mainmenu_comment.svg"
  Delete "$INSTDIR\themes\default\mainmenu_comment_bg.svg"
  Delete "$INSTDIR\themes\default\mainmenu_option.svg"
  Delete "$INSTDIR\themes\default\mainmenu_option_selected.svg"
  Delete "$INSTDIR\themes\default\mainmenu_scomment_bg.svg"
  Delete "$INSTDIR\themes\default\mainmenu_short_comment.svg"
  ...
  Delete "$INSTDIR\themes\default\instrumentmenu_back_highlight.svg"
  Delete "$INSTDIR\themes\default\instrumentmenu_bg.svg"
  Delete "$INSTDIR\themes\default\instrumentmenu_comment.svg"
  Delete "$INSTDIR\themes\default\instrumentmenu_option.svg"
  Delete "$INSTDIR\themes\default\instrumentmenu_option_selected.svg"
